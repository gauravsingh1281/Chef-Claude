export default function RecipeResult() {
  return (
    <section className="w-1/2 mx-auto ">
      <h2 className="font-inter text-3xl font-semibold text-[#141413] mb-5">
      ...
      >
        ...
        <h3 className="text-2xl font-semibold font-inter  text-[#475467]">
          Beef Bolognese Pasta
        </h3>
        <strong className="text-[#141413]">Ingredients:</strong>
        ...
        <strong className="text-[#141413]">Instructions:</strong>
        <ol className="list-decimal ml-6 leading-[35px] text-[#475467]  text-lg">
